//WebConfig
package sv.edu.itca.practicas_profesionales_itca_web.config; // ¿Coincide el paquete?

import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration; // <-- ¿Está esta línea?
        ...
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/api/**") // Para /api/
                        ...
                        .allowedOrigins("http://localhost:5173") // Origen FE
